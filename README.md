...
- エディタ vim
    - パッケージ管理 NeoBundle -> [vim-jetpack](https://github.com/tani/vim-jetpack)
    - ステータスライン lightline.vim -> [vim-airline](https://github.com/vim-airline/vim-airline)
...
- ターミナルマルチプレクサ tmux
    - パッケージ管理 _ -> [tpm](https://github.com/tmux-plugins/tpm)
    - カラースキーマ hybrid -> [Nord](https://www.nordtheme.com/docs/ports/tmux/installation)
- ターミナルエミュレータ iTerm2 -> [Alacritty](https://github.com/alacritty/alacritty)
